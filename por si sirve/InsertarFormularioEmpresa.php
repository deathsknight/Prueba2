...
//		$sql="INSERT INTO PERFILUSUARIOS (USUARIO, PASSWORD, PERFIL) VALUES (?,?,?)";
                ...
                $sql="INSERT INTO EMPRESA (codigoEmpresa,rutEmpresa,nombreEmpresa,passwordEmpresa,direccionEmpresa) VALUES (?,?,?,?,?)";
                
		$resultado=mysqli_prepare($conexion, $sql);
		
//		$ok=mysqli_stmt_bind_param($resultado, "sss", $usu, $con, $perfil);
                $ok=mysqli_stmt_bind_param($resultado, "sssss", $codigoEmpresa, $rutEmpresa, $nombreEmpresa,$passwordEmpresa,$direccionEmpresa);
